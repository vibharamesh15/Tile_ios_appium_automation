...
describe 'The Tile App' do
  ...
  context 'when editing Tile details for name , category' do
    it 'should let users change the Tile name', disabled: true   do
 ...
 #     app = TileListScreen.new @driver
  ...
  #    app.tap_tile 'Keys'
   ...
   #   $helpers.check_and_dismiss_coachmarks
    ...
    it 'should let users change the Tile Ringtone', disabled: true do
      skip('blocked by the ringtone screen')
    end

    it 'should let users change the Tile archetype', disabled: true do
      app = TileListScreen.new @driver
      app.tap_tile 'Keys'
      $helpers.check_and_dismiss_coachmarks
    ...
    it 'should let users unhide a Tile', disabled:false do
